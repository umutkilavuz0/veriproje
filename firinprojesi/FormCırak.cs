...
{
    public partial class FormCırak : Form
    {
        ...
        public FormCırak()
        {
            ...
            this.Paint += new PaintEventHandler(FormCırak_Paint);

        }

        private void FormCırak_Load(object sender, EventArgs e)
        {
            this.FormBorderStyle = FormBorderStyle.None;

        }

        private void FormCırak_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void FormCırak_Paint(object sender, PaintEventArgs e)
        {
