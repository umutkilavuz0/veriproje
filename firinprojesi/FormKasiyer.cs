...
namespace firinprojesi
{
    public partial class FormKasiyer : Form
    {
        ...
        public FormKasiyer()
        {
            ...
            this.Paint += new PaintEventHandler(FormKasiyer_Paint);
        ...
        private void FormKasiyer_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FormKasiyer_MouseDown(object sender, MouseEventArgs e)
        {
