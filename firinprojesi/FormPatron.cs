...
namespace firinprojesi
{
    public partial class FormPatron : Form
    {
        ...
        public FormPatron()
        {
            ...
            this.Paint += new PaintEventHandler(FormPatron_Paint);
        ...
        private void btnCalisanYonetim_Click(object sender, EventArgs e)
        {
            this.Hide();
            FormCalisanYonetim frm = new FormCalisanYonetim();
        ...
        {
            this.Hide(); // FormKasiyer'i gizle
            FormSatis frm = new FormSatis();

            frm.FormClosed += (s, args) => this.Show(); // Satis formu kapanınca Kasiyer formunu tekrar göster
            frm.Show();
        }
        ...
        {
            this.Hide();
            FormRaporlama frm = new FormRaporlama();
            frm.FormClosed += (s, args) => this.Show();
            frm.Show();
        }
